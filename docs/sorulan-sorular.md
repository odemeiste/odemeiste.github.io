...
**9)İstemci sertifikası talebini nereden yapabiliriz?**
...
**15)Bireysel ve kurumsal için ayrı sertifikasyona gelinebilir mi?**
...
**16)Sertifikasyon onay istek formunu ve kontrol listesini nereden bulabiliriz?**
- Sertifikasyon kontrol listesi dokümanına Trip/Tripsit > BKM Online > Ödeme İste > Dokümanlar menüsü altından ulaşabilirsiniz.

**17)Sertifikasyon senaryoları koşulurken nelere dikkat edilmelidir? Ekranlar nasıl olmalıdır?**
...
**18)Sertifikasyon onay isteği nasıl oluşturabiliriz?**
...
**19)Sertifikasyon onay isteği oluşturdum. "Log Bulunamadı" statüsünde kaldı. Yardımcı olabilir misiniz?**
...
**20)Sertifikasyon onay isteği oluşturdum. Senaryolar tiklenmedi. Kontrol edebilir misiniz?**
...
**21)Ödeme İste Sertifikasyon onayı aldım. Üretim ortamına geçiş için neler yapılması gerekir?**
...
**22)Geliştirmeler sırasında doküman ile simülatör arasında fark görüldüğünde hangisi doğrudur? Nasıl ilerlemeliyiz?**
- Her zaman Ödeme İste API İlke ve Kuralları dokümanı dikkate alınmalıdır. 


**23)Ödeme İste talebi yapıldıktan sonra müşteriye bildirim gönderilmesi zorunlu mudur?**
...
**24)Ödeme iste yapılırken hangi hesap türleri kapsama dahildir?**
...
**25)Ödeme İste API kullanımları için ücretlendirme olacak mıdır? Ücretlendirme kapsamında nasıl bir yol haritası izlenecektir?**
...
**26)Kurumsal müşterilerin mobil/internet bankacılık uygulamalarında farklı onay yapısı bulunmaktadır.(Örn: çoklu onay yapısı) Bu kapsamda Ödeme İste talebindeki Kurumsal müşteri bildirim akışı nasıl olmalıdır?**
...
**27)Ödeme İste Hizmetini 3.Taraf kullanıcılara API üzerinden açabilir miyiz?**
- [https://odemeiste.github.io/kurumsal-api/contents/oi-kurumsal-api.html ](https://odemeiste.github.io/kurumsal-api/contents/oi-kurumsal-api.html) linkte detay bilgiye ulaşabilirsiniz.


**28)Ödeme iste talebi için gönderici ve alıcıya onay&red akışlarında anlık bildirim mu yoksa sms mi gidiyor olmalı? SMS gönderimi zorunlu mudur?**
...
**29)Ödeme İste fonksiyonlarını uygulama içerisinde konumlandırırken ana menü isminin "Ödeme İste" olması bir zorunluk mudur?**
...
**30)Ödeme İste altyapısını kullanarak ön yüzde farklı amaca yönelik farklı bir hizmet sunmamız mümkün mü?**
...
**31)Müşterilere gönderilen bildirim üzerindeki butonlarla Ödeme İsteği kabul/red'i yapılabilir mi?**	
...
**32)Alacaklı ÖHS’lerin, kullanım modellerinden asgari “Sonra Kabul Hemen Öde” modelini Alacaklı’ya sunması zorunlu iken, Borçlu ÖHS için tüm modelleri desteklemesi zorunlu mudur?**
...
**33)Sonra Öde modellerinde ödeme iste talepleri talimatlı işlem gibi düşünerek sisteminize kaydedeceğiz. Ödeme iste talebi EFT ile gerçekleştirilebilir mi?**
...
**34)Sonra Öde modellerinde borçlu müşteri tarafından kabul edilen ödeme isteği beklenen ödeme tarihinde gerçekleştirildiğinde alacaklı ya da borçlu hesabın kapalı olması, bakiye yetersiz olması durumunda ödeme iste durumu nasıl güncellenmelidir?**
...
**35)Kabul edilen ödeme iste talebi alacaklı müşteri tarafından iptal edilebilir mi?**
...
**36)Kabul edilen ödeme iste talebi borçlu müşteri tarafından iptal edilebilir mi?**
...
**37)Alacaklı ÖHS olarak müşterimize fonksiyon seçimi yaptırmadan varsayılan E/H değeri gönderebilir miyiz?**
...
**38)Fonksiyonların birbirleriyle kullamı nasıl olmalıdır?**
...
**39)Kısmi ödeme evet olan ödeme iste talebi kabul edilirken minimum tutar gönderme kontrolü var mıdır, bu durum banka kararına mı bırakılmıştır?**
- Borçlu ÖHS insiyatifindedir. 0 TL gönderilemez.

**40)Hemen Öde modellerinde fonksiyonların varsayılan değerleri nasıl gönderilmelidir?**
...
**41)"Şimdi Kabul-Hemen Öde" modelini alacaklı ÖHS sunabilir mi?**
...
**42)Sertifikasyon senaryolarına nereden ulaşabilirim? Sertifikasyon senaryoları için nasıl filtreleme yapmam gerekiyor? Tüm senaryoların koşulması gerekiyor mu?**
...
**43)Sertifikasyona web/mobil aynı sertifikasyon ID ile gelebilir miyiz?**
...
**44)Sertifikasyona bireysel/kurumsal ayrı ayrı sertifikasyon ID ile gelebilir miyiz?**
...
**45)Sertifikasyon onay isteği oluştururken "Müşteri/Kanal Seçimi" nasıl olmalıdır?**
- İlk kez sertifikasyona geliniyor ise; Mobil için **“Bireysel, Kurumsal, Mobil”** seçilmelidir. Web için **“Bireysel, Kurumsal, Web”** seçilmelidir. S2.0 için sertifikasyona geliniyor ise; mobil için **“Bireysel, Kurumsal, Sertifikasyon Güncelleme, Mobil”** seçilmelidir. Web için **“Bireysel, Kurumsal, Sertifikasyon Güncelleme, Web”** seçilmelidir.

**46)FAST loglarını nereden kontrol edebiliriz?**
- Ödeme İste simülatörü “Servis Logları” kısmının altında “Fast Logları” yer almaktadır. Bu bölümden inceleyebilirsiniz.

**47)Sürüm yönetimi ile ilgili detay bilgi bulamadım. Yardımcı olabilir misiniz?**
...
**48)Ödeme Erteleme E olarak oluşturulan ödeme iste talebinde vade tutarı tutardan küçük olabilir mi?**
