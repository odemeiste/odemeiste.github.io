...
- Kurumsal API üzerinden başlatılan ve 03:Fatura, 04: Vergi/Harç/Belediye ve 05: BES  akış türlerinde başlatılan Öİ taleplerinde Borçlu ÖHK'nın bilgilendirilmesi(notifikasyon ve/veya SMS olarak) Borçlu ÖHS insiyatifinde uygun saat dilimlerinde yapılabilir.
